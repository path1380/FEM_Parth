...
FFLAGS = -O3
_SRCS = type_defs.f90 basic_structures.f90 Input_function.f90 basis_function.f90 numbering_convention_defn.f90 legendre_module.f90 local_mat.f90 global_mat.f90 rs_to_xy.f90 approx_fun.f90 proj_prob.f90
